...
class Staff_model extends CI_Model {
    ...
    {
        $violation = $this->db->query("select pelanggaran.* from pelanggaran join users_pengasuh on users_pengasuh.id = pelanggaran.chairmanId where users_pengasuh.username='" . $_SESSION['username'] . "' ORDER BY pelanggaran.createdAt DESC ");

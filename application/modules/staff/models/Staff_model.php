...
class Staff_model extends CI_Model {
    ...
    public function login($username)
    {
        ...
        $user = $this->db->get('users_chairman');
    ...
    {
        $this->db->where('username', $username);
        $this->db->update('users_chairman', array(
            'password' => $pass
        ));
    ...
    {
        $violation = $this->db->query("select pelanggaran.* from pelanggaran join users_chairman on users_chairman.id = pelanggaran.chairmanId where users_chairman.username='" . $_SESSION['username'] . "' ORDER BY pelanggaran.createdAt DESC ");

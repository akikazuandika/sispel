                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-2"><label class=" form-control-label">Nama Wali</label></div>
                                    <div class="col-12 col-md-9">
                                        <p class="form-control-static"><?= $info['waliName'] ?></p>
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-2"><label class=" form-control-label">No. HP Wali</label></div>
                                    <div class="col-12 col-md-9">
                                        <p class="form-control-static"><?= $info['waliPhone'] ?></p>
                                    </div>
                                </div>
                                <div class="row form-group">
